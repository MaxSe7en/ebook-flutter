    ...
    final ffApiRequestBody = '''
{
  ...
  String? userDetailsId(dynamic response) => castToType<String>(getJsonField(
        response,
    ...
    final ffApiRequestBody = '''
{
  ...
  List<String>? name(dynamic response) => (getJsonField(
        response,
        r'''$.data.subcategoryDetails[:].name''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
  ...
  List<String>? image(dynamic response) => (getJsonField(
        response,
        r'''$.data.subcategoryDetails[:].image''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
...
class GetTrendingBooksApiCall {
  ...
  List<String>? authorname(dynamic response) => (getJsonField(
        ...
        true,
          ...
          .withoutNulls
          .toList();
  List<String>? authorid(dynamic response) => (getJsonField(
        response,
        r'''$.data.bookDetails[:].author._id''',
        true,
      ) as List?)
    ...
    final ffApiRequestBody = '''
{
  ...
  List<String>? downloadDetailsId(dynamic response) => (getJsonField(
        response,
        r'''$.data.downloadDetails[:]._id''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
  ...
  List<String>? bookname(dynamic response) => (getJsonField(
        response,
        r'''$.data.downloadDetails[:].bookDetails.name''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
  ...
  List<String>? bookImage(dynamic response) => (getJsonField(
        response,
        r'''$.data.downloadDetails[:].bookDetails.image''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
          .withoutNulls
          .toList();
  List<String>? bookPdf(dynamic response) => (getJsonField(
        response,
        r'''$.data.downloadDetails[:].bookDetails.pdf''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
  ...
  List<String>? bookId(dynamic response) => (getJsonField(
        response,
        r'''$.data.downloadDetails[:].bookDetails._id''',
        true,
      ) as List?)
          ?.withoutNulls
          .map((x) => castToType<String>(x))
