...
import '/components/no_categories_yet_widget.dart';
        ...
        body: SafeArea(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: (_model.apiRequestCompleter ??= Completer<ApiCallResponse>()
                  ..complete(EbookGroup.getbookbysubcategoryApiCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final columnGetbookbysubcategoryApiResponse = snapshot.data!;
                            ...
                            return Builder(
                              builder: (context) {
                                if (EbookGroup.getbookbysubcategoryApiCall
                                            .bookDetailsList(
                                          columnGetbookbysubcategoryApiResponse
                                              .jsonBody,
                                        ) !=
                                        null &&
                                    (EbookGroup.getbookbysubcategoryApiCall
                                            .bookDetailsList(
                                      columnGetbookbysubcategoryApiResponse
                                          .jsonBody,
                                    ))!
